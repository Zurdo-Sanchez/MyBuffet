...
dependencies {
    ...
    implementation ("androidx.navigation:navigation-compose:2.5.3") // o la última versión estable
    implementation ("androidx.compose.ui:ui:1.4.3") // o tu versión de Compose
